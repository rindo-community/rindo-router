import { Component, Prop, Element, Watch, ComponentInterface, h } from '@rindo/core';
import { QueueApi } from '@rindo/core/dist/declarations';
import { LocationSegments, MatchResults, RouteViewOptions } from '../../global/interfaces';
import ActiveRouter from '../../global/active-router';
import { matchPath } from '../../utils/match-path';

interface Child {
  el: HTMLRindoRouteElement,
...
const isHTMLRindoRouteElement = (elm: Element): elm is HTMLRindoRouteElement => {
  return elm.tagName === 'RINDO-ROUTE';
}

@Component({
  tag: 'rindo-route-switch'
})
export class RouteSwitch implements ComponentInterface {
  ...
  async regenerateSubscribers(newLocation: LocationSegments) {
    ...
    this.subscribers = Array.prototype.slice.call(this.el.children)
      .filter(isHTMLRindoRouteElement)
