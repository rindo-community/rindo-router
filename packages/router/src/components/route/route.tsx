...
export class Route implements ComponentInterface {
  ...
  @Element() el!: HTMLRindoRouteElement;
  ...
  computeMatch(newLocation: LocationSegments) {
    const isGrouped = this.group != null || (this.el.parentElement != null && this.el.parentElement.tagName.toLowerCase() === 'rindo-route-switch');
